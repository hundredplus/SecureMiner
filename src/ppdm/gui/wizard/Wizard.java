...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
    ...
    public int showModalDialog() {
        ...
        wizardDialog.setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\Code\\Netbeans\\PPDM-Cache\\src\\ppdm\\images\\logoSmall.gif"));
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        ...
        } else if (evt.getPropertyName().equals(WizardModel.FINISH_BUTTON_TEXT_PROPERTY)){
        ...
        } else if (evt.getPropertyName().equals(WizardModel.FINISH_BUTTON_ENABLED_PROPERTY)) {
        ...
        } else if (evt.getPropertyName().equals(WizardModel.FINISH_BUTTON_ICON_PROPERTY)) {
...
//        backButton = new JButton(new ImageIcon("ppdm/gui/wizard/backIcon.gif"));
...
//        buttonPanel.add(separator, BorderLayout.NORTH);
        ...
        wizardDialog.setLocation(150, 150);
//        wizardDialog.setLocationRelativeTo(null);
    ...
    private static Object getImage(String name) {
        ...
        try {
            Class c = Class.forName("ppdm.gui.wizard.Wizard");
    ...
    static {
        ...
        try { 
            ...
            PropertyResourceBundle resources = (PropertyResourceBundle)
                ResourceBundle.getBundle("ppdm.gui.wizard.wizard");
...
//            BACK_ICON = new ImageIcon((URL)new URL(""));
//            NEXT_ICON = null;
//            CANCEL_ICON = null;
//            FINISH_ICON = null;

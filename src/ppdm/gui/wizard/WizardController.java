...
//        model.setBackButtonIcon(Wizard.BACK_ICON);
        ...
        if (descriptor.getNextPanelDescriptor() != null
                && !(descriptor.getNextPanelDescriptor()
        ...
        //  If the panel in question is the last panel in the series, set
        //  the Next button to Disable. Otherwise, set the text back to Next.
...
//            model.setNextButtonText(Wizard.NEXT_TEXT);
//            model.setNextButtonIcon(Wizard.NEXT_ICON);
        }

 ...
 * @author  Tran Huy Duc
 */
public class KMeansResultFrame extends javax.swing.JInternalFrame {
    KMeansParty kMeansParty;
    private volatile Thread miningThread;

    boolean firstClick;
    /** Creates new form KMeansResultFrame */
    public KMeansResultFrame(KMeansParty kMeansParty) {
        this.kMeansParty = kMeansParty;     
        initComponents();
    }
    
    /** Creates new form KMeansResultFrame */
    public KMeansResultFrame() {
        initComponents();
    }
...
private void jbtnStopActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnStopActionPerformed
    try{
        kMeansParty.stopServer = true;
        kMeansParty.stopServer();
...
public void startServer(){
    try {
//        if (!PortCheck.isAvailable(kMeansParty.port)) return;
        jbtnStart.setEnabled(false);
        jbtnStop.setEnabled(true);
        kMeansParty.stopServer = false;
        kMeansParty.startServer(kMeansParty.port);
        jlblStatus.setText("Server started at port " + kMeansParty.port);
        
    } catch (Exception ex) {
        if (kMeansParty.stopServer)
            ErrorController.show(jlblStatus, ex);
    }
    ...
    miningThread = new Thread() {
        ...
        public void run() {
            try {
                ...
                kMeansParty.startMining();
                kMeansParty.displayResults(jtxaResult);

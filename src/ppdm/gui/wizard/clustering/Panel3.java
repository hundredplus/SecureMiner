...
import ppdm.algo.clustering.ClusterData;
...
//                jlblSupport.setText(Integer.toString(itemList.get(rowIndex).calSupport()));
    ...
    private void initComponents() {
        ...
        jcmbDataType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Vertical", "Horizontal" }));
        ...
        jLabel5.setText("Can deal only with numeric data. Missing values is NOT accepted.");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(jtxtDataFile, javax.swing.GroupLayout.DEFAULT_SIZE, 363, Short.MAX_VALUE)
                                .addGap(18, 18, 18)
                                .addComponent(jLabel8)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jcmbDataType, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
...
//            initTable();
            ...
            inputData = ClusterData.readData(filename);
            dataSize = inputData.size()-1;

            jlblNoOfAtt.setText(Integer.toString(inputData.get(0).length));
            ...
            for (int i = 0; i < inputData.get(0).length; i++) {
                Object[] rowData = {i + 1, inputData.get(0)[i]};
                dtm.addRow(rowData);
            }

...
public class WizardModel {
     ...
     * Property identification String for the Next button's icon
     */
    public static final String FINISH_BUTTON_ICON_PROPERTY = "finishButtonIconProperty";
    /**
    ...
    void setFinishButtonText(Object newText) {
        ...
        Object oldText = getFinishButtonText();
        if (!newText.equals(oldText)) {
    ...
    Icon getFinishButtonIcon() {
        return (Icon)buttonIconHashmap.get(FINISH_BUTTON_ICON_PROPERTY);
    }

    public void setFinishButtonIcon(Icon newIcon) {
    ...
    Boolean getFinishButtonEnabled() {
        return (Boolean)buttonEnabledHashmap.get(FINISH_BUTTON_ENABLED_PROPERTY);
    }
    ...
    void setFinishButtonEnabled(Boolean newValue) {
        ...
        if (newValue != oldValue) {
            ...
            firePropertyChange(FINISH_BUTTON_ENABLED_PROPERTY, oldValue, newValue);
        }
    }
